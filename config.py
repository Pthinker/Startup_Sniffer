...
SQLALCHEMY_DATABASE_URI = 'mysql://{user}:{pwd}@localhost/startup_sniffer?charset=utf8'.format(user=DB_USER, pwd=DB_PWD)
...
ANGELLIST_TOKEN = '14026bd1a099ae7277d4b0766eab9528'
CRUNCHBASE_API_KEY = 'sn86p65fg2m5cwu6gjtz7dep'

BITLY_ACCESS_TOKEN = '96d1beab58673cf4cfe2137d12a0137f99a8c7ab'
